...
const translations = {
  en: {
    ...
    matchingTitle: "Marriage Matching (Nakshatra-based, 36 points)",
    matchingIntro: "Compatibility score (0–36) by Janma Nakṣatra (birth star). Uses the same star-matching logic as traditional Guna Milan.",
    matchingYourNakshatraLabel: "Your Janma Nakṣatra",
    matchingPartnerNakshatraLabel: "Partner Janma Nakṣatra",
    matchingSelectPlaceholder: "Select partner Nakshatra…",
    matchingButton: "Calculate Compatibility",
    matchingScoreLabel: "Compatibility Score",
    matchingBandUnknown: "Select partner Nakshatra to see the score.",
    matchingBandLow: "Low compatibility on this Nakshatra-based scale.",
    matchingBandAverage: "Average or workable compatibility on this Nakshatra-based scale.",
    matchingBandGood: "Good overall compatibility on this Nakshatra-based scale.",
    matchingBandExcellent: "Excellent compatibility on this Nakshatra-based scale.",
  },
  as: {
    ...
    matchingTitle: "বিবাহ মিলন (নক্ষত্র ভিত্তিক, ৩৬ পইন্ট)",
    matchingIntro: "জন্ম নক্ষত্র (তাৰা) অনুসৰি মিলন স্কোৰ (০–৩৬)। পৰম্পৰাগত গুণ মিলনৰ দৰে একে তাৰা মিলন ব্যৱহৃত।",
    matchingYourNakshatraLabel: "আপোনাৰ জন্ম নক্ষত্র",
    matchingPartnerNakshatraLabel: "সঙ্গীৰ জন্ম নক্ষত্র",
    matchingSelectPlaceholder: "সঙ্গীৰ নক্ষত্র বাছনি কৰক…",
    matchingButton: "মিলন গণনা কৰক",
    matchingScoreLabel: "মিলন স্কোৰ",
    matchingBandUnknown: "স্কোৰ চাবলৈ সঙ্গীৰ নক্ষত্র বাছনি কৰক।",
    matchingBandLow: "এই নক্ষত্র ভিত্তিক স্কেলত মিলন নূন্যতম।",
    matchingBandAverage: "এই নক্ষত্র ভিত্তিক স্কেলত মধ্যম বা চলি যাবলগীয়া মিলন।",
    matchingBandGood: "এই নক্ষত্র ভিত্তিক স্কেলত ভাল মিলন।",
    matchingBandExcellent: "এই নক্ষত্র ভিত্তিক স্কেলত অতি উৎকৃষ্ট মিলন।",
  },
};
