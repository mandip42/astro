...
const translations = {
  en: {
    ...
    matchingTitle: "Marriage Matching (Lagna-based, 36 points)",
    matchingIntro: "Quick Lagna-based compatibility score on a 36-point scale. This is a simplified guide and not a full traditional kuṇḍali match.",
    matchingYourLagnaLabel: "Your Lagna",
    matchingPartnerLagnaLabel: "Partner Lagna",
    matchingSelectPlaceholder: "Select partner Lagna…",
    matchingButton: "Calculate Compatibility",
    matchingScoreLabel: "Compatibility Score",
    matchingBandUnknown: "Select partner Lagna to see the score.",
    matchingBandLow: "Low compatibility on this simplified Lagna-based scale.",
    matchingBandAverage: "Average or workable compatibility on this Lagna-based scale.",
    matchingBandGood: "Good overall compatibility on this Lagna-based scale.",
    matchingBandExcellent: "Excellent compatibility on this Lagna-based scale.",
  },
  as: {
    ...
    matchingTitle: "বিবাহ মিলন (লগ্ন ভিত্তিক, ৩৬ পইন্ট)",
    matchingIntro: "সৰল লগ্ন ভিত্তিক ৩৬ পইন্ট স্কেলত মিলনৰ এক দ্রুত মূল্যায়ন। ই পূৰ্ণ পৰম্পৰাগত কুন্ডলী মিলনৰ বিকল্প নহয়।",
    matchingYourLagnaLabel: "আপোনাৰ লগ্ন",
    matchingPartnerLagnaLabel: "সঙ্গীৰ লগ্ন",
    matchingSelectPlaceholder: "সঙ্গীৰ লগ্ন বাছনি কৰক…",
    matchingButton: "মিলন গণনা কৰক",
    matchingScoreLabel: "মিলন স্কোৰ",
    matchingBandUnknown: "স্কোৰ চাবলৈ সঙ্গীৰ লগ্ন বাছনি কৰক।",
    matchingBandLow: "এই সৰল লগ্ন ভিত্তিক স্কেলত মিলন নূন্যতম।",
    matchingBandAverage: "এই লগ্ন ভিত্তিক স্কেলত মধ্যম বা চলি যাবলগীয়া মিলন।",
    matchingBandGood: "এই লগ্ন ভিত্তিক স্কেলত ভাল মিলন।",
    matchingBandExcellent: "এই লগ্ন ভিত্তিক স্কেলত অতি উৎকৃষ্ট মিলন।",
  },
};
